...
echo_and_run cd "/home/hui/UAV/src/rotors_simulator/rqt_rotors"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/hui/UAV/src/rotors_simulator/rqt_rotors/setup.py" \
     \
    build --build-base "/home/hui/UAV/build/rotors_simulator/rqt_rotors" \
    install \
    --root="${DESTDIR-/}" \
