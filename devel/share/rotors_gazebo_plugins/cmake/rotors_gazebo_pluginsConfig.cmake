...
if("TRUE" STREQUAL "TRUE")
  set(rotors_gazebo_plugins_SOURCE_PREFIX /home/hui/UAV/src/rotors_simulator/rotors_gazebo_plugins)
  set(rotors_gazebo_plugins_DEVEL_PREFIX /home/hui/UAV/devel)
  ...
  set(rotors_gazebo_plugins_INSTALL_PREFIX /home/hui/UAV/install)
...
if(NOT "/home/hui/UAV/src/rotors_simulator/rotors_gazebo_plugins/include;/usr/include/eigen3;/usr/include/opencv4 " STREQUAL " ")
  set(rotors_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/hui/UAV/src/rotors_simulator/rotors_gazebo_plugins/include;/usr/include/eigen3;/usr/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hui/UAV/src/rotors_simulator/rotors_gazebo_plugins/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hui/UAV/devel/lib;/home/hui/bingda_ws/devel/lib;/opt/ros/noetic/lib)
